"""
Train lai model segmentation (DeepLabV3-ResNet50) tu dataset COCO export
cua Roboflow (dataset_v1_coco/{train,valid,test}/_annotations.coco.json).

Cach dung:
    python3 train_segmentation.py

Output: segmentation_new.tar (dung format {"state_dict": ...} khop voi
cach patrol_robot.py dang load model hien tai).
"""
import json
import os
import time
...
#  CAU HINH
# ============================================================
DATA_ROOT = "/mnt/big/AGV_ANLEE/train_data/dataset_v1_coco"
OUT_PATH = "/mnt/big/AGV_ANLEE/train_data/segmentation_mobilenetv2.tar"
