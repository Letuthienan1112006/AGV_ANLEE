"""
2026-09-09: BAN SAO cua train_segmentation_bridged_v2.py, doi DATA_ROOT
sang dataset_v2_coco - bo du lieu MOI: nguoi dung tu tay label lai toan
bo "line" thanh 1 polygon lien tuc qua khoang trong (khong dung convex-
hull tu dong nhu ban bridged nua), CONG THEM anh moi thu thap (~250 anh,
day tay xe di vong quanh, da loc mo/loc anh loi). Kiem tra so bo: trung
binh CHI 1.01 line-annotation/anh (so voi 2.33 cua bo cu) - xac nhan
label lien tuc dung nhu mong muon tren gan toan bo dataset. Day la ung
cu vien manh nhat tu truoc gio - so sanh bang compare_models.py voi
segmentation_bridged_v2.tar (ket qua tot nhat hien tai) truoc khi dua
len xe.
...
#  CAU HINH
# ============================================================
DATA_ROOT = "/mnt/big/AGV_ANLEE/train_data/dataset_v2_coco_raw"
OUT_PATH = "/mnt/big/AGV_ANLEE/train_data/segmentation_v2data.tar"
...
def main():
    ...
    train_loader = DataLoader(
        ...
        # 2026-09-09: drop_last=True - 2673 anh / batch 8 du 1 anh o batch
        # cuoi, BatchNorm loi "Expected more than 1 value per channel" khi
        # batch=1 luc training (mode train can >=2 sample de tinh variance).
        # Bo qua 1 anh le moi epoch khong dang ke, an toan hon la doi
        # BATCH_SIZE.
        drop_last=True,
    )
